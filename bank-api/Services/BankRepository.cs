...
namespace BankApi.Services {
    public class BankRepository : IBankRepository {
        ...
        {
            return await _context.Transaction.OrderByDescending( t => t.CreatedAt ).Where( t => t.DebitedFrom != -1 && ( t.CreditTo == transfer.AccNo || t.DebitedFrom == transfer.AccNo ) ).ToListAsync();
            throw new NotImplementedException();
        }
    }
}