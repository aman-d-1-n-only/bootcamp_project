...
const FundTransfer = () => {
  ...
  const handleTransfer = (data) => {
    axios
      .post(`http://localhost:5165/fundTransfer`, data, {
        headers: {
      ...
      <Card className="w-96">
        ...
        <CardBody className="px-10">
          ...
          >
            <Input
              {...register("accNo1", {
                required: "Sender's Account Number is required",
                pattern: {
                  value: /^[1-9][0-9]*$/,
            ...
            {errors.accNo1 && (
              <span className="-mt-3 flex items-center gap-1 font-normal text-red-600 text-sm">
                {errors.accNo1.message}
              </span>
            )}

            <Input
              {...register("accNo2", {
                required: "Receiver's Account Number is required",
                pattern: {
                  value: /^[1-9][0-9]*$/,
                  message: "Enter Valid Account Number",
                },
