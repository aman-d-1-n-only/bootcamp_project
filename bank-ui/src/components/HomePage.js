  ...
  return (
    <>
      ...
      <div className=" lg:h-full sm:min-h-screen max-w-full bg-gray-100 overflow-x-none">
        <div
          className="py-[8.5rem] bg-cover bg-no-repeat bg-fixed relative "
          style={{
        ...
        >
          ...
          <div className="container m-auto text-center opacity-100 ">
            ...
            <h3 className="text-2xl mb-8 text-gray-400 ont-normal leading-wide ">
              Thank you for choosing Namma Bank for your financial needs.
            </h3>
            <a href="#services">
        ...
        <div className="w-full h-full bg-gray-100 pt-6 overflow-x-none">
          <section
            id="services"
            className="container mx-auto p-10 bg-white  shadow-md my-8 overflow-x-none"
          >
            <h4 className="text-3xl font-bold text-center text-gray-600 mb-8">
              Our Services
            </h4>
            <Dashboard />
          </section>
