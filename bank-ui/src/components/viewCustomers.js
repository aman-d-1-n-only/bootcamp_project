...
export const SeeCustomers = () => {
    ...
    return (
        <>
            ...
            <div className='flex grid place-items-center justify-self-center'>
                        ...
                        <React.Fragment key={index}>
                            <div key={index}>
                                <Card className="m-2 mt-6 w-96 p-2 bg-indigo-200 rounded-xl transform transition-all hover:-translate-y-2 duration-300 shadow-lg hover:shadow-2xl">
                                    ...
                                    <CardFooter className="flex flex-row place-items-center justify-content pt-0 mt-6">

                                        <Button onClick={() => {
                                            navigate('/customer/add-account', {
                                                state: {
                                                    data1: item.custId,
                                                    data2: item.name
                                                }
